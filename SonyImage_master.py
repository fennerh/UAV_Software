...
def correct_images(infolder,vigfolder,t5file,camera,average):
    '''
    ...
    ----------
    infolder : str
        Folder path to uncorrected tiff imagery.
    vigfolder : str
        Folder path to location of vignetting model images.
    t5file : str
...
def SonyImage_Master( variables):
    '''
    ...
    correct_images(outfolder,vigdest,t5file,camera,average)
